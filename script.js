...
const listoreTab =
    document.getElementById("listoreTab");
...
const listorePage =
    document.getElementById("listorePage");
...
function toggleItem(index) {
    ...
    const item =
        lists[currentListId].items[index];
...
function deleteItem(index) {
    ...
    lists[currentListId].items.splice(
        index,
        1
    );
